...
{
		/* The need for an IMAGE telegram is questionable.  We could have the client
			...
			REQ_IMAGE_LIVE and respond with CMD_FILE_TRANSFER (picture & html), 
			CMD_SHOW_HTML_FILE.
