...
public:
    ...
    void                convert_unit    ( );     // if user specified inches and program calls for feet.
    void                print_results   ( );
...
class BidirectionalParameter : public Parameter
{
public:
    BidirectionalParameter();
    ~BidirectionalParameter();
    
    virtual void        construct_regex ( );
    bool                is_positive_direction();
    bool                is_negative_direction();
    
    string              m_positive_regexpression;
    string              m_negative_regexpression;
};
...
class LengthWidthHeight : public Parameter
{
public:
    LengthWidthHeight();
    ~LengthWidthHeight();
