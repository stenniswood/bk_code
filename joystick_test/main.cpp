...
void init_roboclaws()
{
	...
	char text[512];
	mot.ReadVersion(0x80, text );	printf("Claw #1 - \n", text );
	mot2.ReadVersion(0x80, text );	printf("Claw #2 - \n", text );
	mot3.ReadVersion(0x80, text );	printf("Claw #3 - \n", text );
	mot4.ReadVersion(0x80, text );	printf("Claw #4 - \n", text );
}
