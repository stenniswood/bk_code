...
/*
	m_bottom.Relocate( 0.0, 0., 0.0);
	m_back.Relocate( 0., 0.0, -m_bottom.depth/2.);  
	m_left_side.Relocate    ( m_bottom.width, 0.0, 0.);
	m_right_side.Relocate( 0., 0.0, 0.);
	m_facePlate.Relocate( 0., -1.0, m_bottom.depth/2.);
*/