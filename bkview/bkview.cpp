...
int main(int argc, char **argv)
{
	...
	//print_darray ( "ScanPixels", v_delta, 640 );
	/*init_Segments    ( 640     );
	calc_averages_seg( v_delta );
	calc_stddevs_seg ( v_delta );
	print_seg_stats  (         );
	scan_combine_segments(	   );
	//scan_split_segment( v_delta );
	print_seg_stats   (         ); */
//	calc_thresholds( v_delta, v_avg, v_stddev );


// Code demo'd at Ann Arbor coders
	// GENERATE SCAN LINE:
