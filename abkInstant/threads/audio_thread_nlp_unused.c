/* This thread (duplicated form serverthread.c) receives incoming audio
	done asynchronously and either plays to the device, stores into wave file,
	monitors for sounds, or reroutes to another device (call forwarding)
