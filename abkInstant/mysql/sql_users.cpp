...
static char* append_float( float mFloat )
{
    static char tmp[16];
...
static char* form_date_string( struct tm& time_bd )
{
    static char tmp[16];
...
static char* form_time_string( struct tm time_bd )
{
    static char tmp[32];
...
static char* form_date_time_string( struct tm& time_bd )
{
    static char tmp[32];
...
{
    query_string =  "SELECT username,password FROM ";
    query_string += sql_user_dbase_name;
    query_string += ".Users ";
